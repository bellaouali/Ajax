        ...
        $.ajax({
            ...
            <div class="card">
              <div class="row">
                ...
                <div class="col-md-3">
                  <li class="badge badge-dark">Forks: ${repo.forks_count}</li>
                  <li class="badge badge-primary">Watchers: ${repo.watchers_count}</li>
                  <li class="badge badge-success">Stars: ${repo.stargazers_count}</li>
                </div>
                <div class="col-md-2">
